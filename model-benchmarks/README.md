...
## 2026 年 09 月主流模型动态 - 2026-09-13 更新

### Hugging Face Trending 文本生成模型 (Top 15)

| 排名 | 模型 | 参数量 | 下载量 | 趋势 | 备注 |
|------|------|--------|--------|------|------|
| 1 | **deepseek-ai/DeepSeek-V4.1-Flash** | 763B | 244k | 🆕 | 3天前更新，多模态 |
| 2 | **openbmb/MiniCPM5-2B** | 3B | 150k | 🆕 | 1天前更新，面壁小钢炮 |
| 3 | **Edge0/Edge0-35B-A3B-preview** | 35B | 3.55k | 🆕 | 4天前更新 |
| 4 | **nex-agi/Nex-N2.5-mini** | 35B | 3.97k | 🆕 | 5天前更新，Agent 专用 |
| 5 | **Qwen/Qwen3.8-27B** | 28B | 7.77M | → | 阿里主力模型 |
| 6 | **XHToken/Spark-X2.5-4B** | 4B | 21.3k | 🆕 | 10天前更新 |
| 7 | **nex-agi/Nex-N2.5-Pro** | 397B | 30.3k | 🆕 | 3天前更新，Agent 旗舰 |
| 8 | **ISTA-DASLab/Qwen3.8-27B-GSQ-RCO-GGUF** | 27B | 770k | 🆕 | 11天前更新 |
| 9 | **Lightricks/LTX-2.5** | - | 1.55M | 🆕 | 12天前更新，视频生成 |
| 10 | **m-a-p/YuE2-3B** | 4B | 3.71k | 🆕 | 2天前更新，音频生成 |
| 11 | **unsloth/Qwen3.8-27B-GGUF** | 27B | 11M | → | 量化版持续热门 |
| 12 | **zai-org/GLM-5.3-Flash** | 321B | 1.58M | 🆕 | 6天前更新 |
| 13 | **google/timesfm-3.0-pytorch** | 0.3B | 798k | 🆕 | 11天前更新，时序预测 |
| 14 | **MiniMaxAI/MiniMax-H3** | 33B | 4.82M | → | 视频生成旗舰 |
| 15 | **Qwen/Qwen3.8-Flash-Next** | 180B | 624k | 🆕 | 17天前更新 |
...
- **参数量**: 763B
- **下载量**: 244k (3天前更新)
- **特点**: 多模态 Flash 版本，DeepSeek 最新的高效多模态模型

#### Nex-N2.5-Pro (Nex-AGI)

- **参数量**: 397B
- **下载量**: 30.3k (3天前更新)
- **特点**: Agent 专用旗舰模型，介于 mini 和 Max 之间

#### GLM-5.3-Flash (智谱 AI)

- **参数量**: 321B
- **下载量**: 1.58M (6天前更新)
- **特点**: 智谱最新 Flash 版本，高效多模态

#### timesfm-3.0 (Google)

- **参数量**: 0.3B
- **下载量**: 798k (11天前更新)
- **特点**: Google 时序预测模型，轻量高效

### 模型趋势分析 (2026-09-13)

1. **DeepSeek-V4.1-Flash 新发布**: 3天前更新，多模态能力持续增强

2. **Nex-AGI Agent 系列完整**: Nex-N2.5-mini (35B) → Nex-N2.5-Pro (397B) → Nex-N2.5-Max (1.6T)，完整覆盖轻量到旗舰

3. **Qwen3.8 生态持续扩张**: 
   - 原生版: 7.77M 下载
   - GGUF 量化版: 11M 下载 (持续霸榜)
   - Flash-Next: 624k 下载
...
5. **量化模型仍是主流**: GGUF 格式下载量远超原生版本

### 小模型专精榜 (2026-09-13 更新)

| 模型 | 参数 | 专精领域 | 评分 | 备注 |
|------|------|----------|------|------|
| Nex-N2.5-mini | 35B | Agent | ⭐⭐⭐⭐⭐ | Agent 专用家族 |
| Qwen3.8-27B-GGUF | 27B | 通用 | ⭐⭐⭐⭐⭐ | 11M 下载持续霸榜 |
| MiniCPM5-2B | 3B | 轻量高效 | ⭐⭐⭐⭐ | 面壁小钢炮最新版 |
| GLM-5.3-Flash | 321B | 多模态 | ⭐⭐⭐⭐ | 智谱最新 |
| DeepSeek-V4.1-Flash | 763B | 多模态 | ⭐⭐⭐⭐ | 3天前更新 |
